#Copyright 2023 Tomas Mancera Villa 98649 - Alejandro Salazar 97502 - Sebastian Lopez 97500 - Juan Pablo Silvestre 99127
...
peliculas = [ 
    ...
    {'titulo': 'avengers end game', 'año_estreno':2017, 'recaudacion':230000, 'valoracion_publico': 4.9},
        {'titulo': 'yoi ironthor iron avengers', 'año_estreno':2017, 'recaudacion':1, 'valoracion_publico': 5},
...
#Menu=========(se define la funcion main en la cual se encuentra el menu)==============================================================
def main():
    x = 0

    while x != 9:
        x = int(input("\n--------------Inserta la opcion que quieras-------------\n1) Ordenar listas\n2) Imprimir la pelicula con mayor recaudacion\n3) Imprimir peliculas con valoracion 5\n4) Imprimir la informacion de la pelicula Avengers infinity war\n5) Imprimir posicion de la pelicula StarWars the return of Jedi \n6) Imprimir cantidad recaudada por las peliculas que contengan la palabra Avengers\n7) Imprimir peliculas con fecha de estreno en 2017 \n8) Imprimir peliculas que inician con la palabra Iron \n9) Salir \n")
    )
        if x == 1:
            timSort(peliculas)
            imprimir_titulo()
